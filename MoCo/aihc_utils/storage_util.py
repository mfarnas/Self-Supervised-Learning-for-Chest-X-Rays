...
if str(getpass.getuser()) == 'jby':
    ...
    STORAGE_ROOT = Path('/home/ameera/Desktop/Medical_imaging/MoCo-CXR/moco_pretraining/moco/deep/group/aihc-bootcamp-spring2020/cxr_fewer_samples/experiments')
