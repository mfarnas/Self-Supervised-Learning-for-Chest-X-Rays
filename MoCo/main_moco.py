...
def main():
    ...
    print(args)
    print(args.exp_name)
    print(f'moco{"v2" if args.mlp else "v1"}')
...
def main_worker(gpu, ngpus_per_node, args, checkpoint_folder):
    ...
    #moco v2 default normalization
    #normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],
    #                                std=[0.229, 0.224, 0.225])
    #moco v2 normalization for chexpert  
    normalize = transforms.Normalize(mean=[.5020, .5020, .5020],
...
def accuracy(output, target, topk=(1,5)):
    ...
    with torch.no_grad():
        ...
        for k in topk:
            ...
            #if top 1, will have 1 array of 16 elements 
            #if top 5 will have 5 arrays of 16 elements 
            # print(f'view(-1) {correct[:k].reshape(-1)}')
            # print(f'correct_k{correct_k}')
            # print(f'product {correct_k.mul_(100.0/16)}')
